...
class EnginesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engine" do
    assert_difference("Engine.count") do
      post engines_url, params: { engine: { description: @engine.description, feature_id: @engine.feature_id, name: @engine.name } }
    end
  ...
  test "should update engine" do
    patch engine_url(@engine), params: { engine: { description: @engine.description, feature_id: @engine.feature_id, name: @engine.name } }
